...
const { cadastrarTransacao, listarTransacoes, detalharTransacaoId, atualizarTransacao, deletarTransacao, extratoTransacoes } = require('./controladores/transacoes/endPointsTransacao');
